        ...
        if valid_name:
            ...
            if time_input:
                ...
                if update_covid_data:
                    ...
                    if repeat_update:
                        list_of_repeated_updates.append(repeat_scheduled_covid_update(time_input,update_name,schedule_covid_updates))
                ...
                if update_news_data:
                    ...
                    update_data.append(event_dict)
                    if repeat_update:
                        list_of_repeated_updates.append(repeat_scheduled_news_update(time_input,update_name,update_news))
